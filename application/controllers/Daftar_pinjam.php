...
class Daftar_pinjam extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = "http://localhost:8080/perpustakaan/daftar_pinjam/index";
        ...
        $this->load->view('user/daftar pinjam/index', $data);
